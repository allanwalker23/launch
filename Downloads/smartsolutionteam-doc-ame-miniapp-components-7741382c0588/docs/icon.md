...
![icon](assets/images_components/v2.0.0/ameicon.png)
...
| ----------- | ------------------------------------------------------------------- | ------ | ------- | ----------- |
| color       | Define a cor do ícone de acordo com as cores definidas da aplicação | String | null    | não         |
| icon        | Nome do icone que pode ser encontrado na lista abaixo               | String | null    | sim         |
